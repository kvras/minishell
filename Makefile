...
SRC = minishell.c ft_functions/ft_malloc.c node.c pwd.c cd.c env.c ayoub.c signals.c ft_functions/ft_strjoin.c ft_functions/ft_strncmp.c \
	...
	export.c ft_functions/ft_substr.c ft_functions/ft_putchar_fd.c ft_functions/ft_putendl_fd.c ft_functions/ft_itoa.c parsing_helpers.c\
	ft_functions/ft_atoi.c exit.c echo.c unset.c export1.c ft_functions/ft_ft_strdup.c ft_functions/ft_ft_strjoin.c core_parsing.c ft_functions/ft_strtrim.c
OBJ = $(SRC:.c=.o)
